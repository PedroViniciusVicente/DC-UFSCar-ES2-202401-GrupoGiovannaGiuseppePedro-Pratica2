...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    ...
    "statcard.totalrepos": {
      ar: "د ټولټال ریپوز شمیره",
      cn: "回购总数量 (repos）",
      "zh-tw": "回购总数量（repos）",
      cs: "Celkem hvězd",
      de: "Gesamtzahl der Repos",
      en: "Total Repos Count",
      bn: "সর্বমোট Star",
      es: "Recuento total de repositorios",
      fr: "Nombre total de pensions",
      hu: "Csillagok",
      it: "Stelle totali",
      ja: "合計リポジトリ数",
      kr: "받은 스타 수",
      nl: "Totaal Sterren Ontvangen",
      "pt-pt": "Total de Repos",
      "pt-br": "Total de Repos",
      np: "कुल रिपो गणना",
      el: "Σύνολο Αστεριών",
      ru: "Общее количество РЕПО",
      "uk-ua": "Всього зірок",
      id: "Total Bintang",
      ml: "ആകെ നക്ഷത്രങ്ങൾ",
      my: "Jumlah Bintang",
      sk: "Hviezdy",
      tr: "Toplam Yıldız",
      pl: "Całkowita liczba repozytoriów",
      uz: "Yulduzchalar",
      vi: "Tổng Số Sao",
      se: "Antal intjänade stjärnor",
    },
    "statcard.totalforks": {
      ar: "إجمالي عدد الشوكات",
      cn: "獲標星數（forks）",
      "zh-tw": "累计提交数（forks）",
      cs: "Celkem hvězd",
      de: "Gesamtzahl der Gabeln",
      en: "Total Forks Count",
      bn: "সর্বমোট Star",
      es: "Recuento total de bifurcaciones",
      fr: "Nombre total de fourchettes",
      hu: "Csillagok",
      it: "Stelle totali",
      ja: "フォークの合計数",
      kr: "받은 스타 수",
      nl: "Totaal Sterren Ontvangen",
      "pt-pt": "Total de Forks",
      "pt-br": "Total de Forks",
      np: "कुल फोर्क गणना",
      el: "Σύνολο Αστεριών",
      ru: "Общее количество форков",
      "uk-ua": "Всього зірок",
      id: "Total Bintang",
      ml: "ആകെ നക്ഷത്രങ്ങൾ",
      my: "Jumlah Bintang",
